# Project 4 - *Emoji Memory Match*

Submitted by: **Luis Delgado**

**Emoji Memory Match* is an app that let's user flips cards in a grid of 4x3 to find matching cards and win when none is left.
...
[Memory Match Demo](https://imgur.com/dLRuRV2).


## Notes

It was challenging to manage the animations effects, the flipping and disappearing features of the App.

## License

    Copyright [2026] [Luis Delgado]
